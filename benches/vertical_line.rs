...
fn bench_vertical_line(c: &mut Criterion) {
    let mut group = c.benchmark_group("vertical_line");
            ...
            |b, &n| {
                ...
                for agent_idx in 0..n {
                    ...
                    for wp_idx in 0..num_waypoints {
                        // All agents on x = 0, moving vertically
                        let y = (wp_idx as f32 + agent_idx as f32 * 0.1) * step_dist;
                        poses.push(Isometry2::new(Vector2::new(0.0, y), 0.0));
                    }
...
criterion_group!(benches, bench_vertical_line);
